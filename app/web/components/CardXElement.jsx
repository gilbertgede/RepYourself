...
export default class CardXElement extends Component {
  render() {
    ...
    var backDisplay = {pointerEvents: "auto", color:"white", cursor: "pointer"};
    if (back == undefined) {
    ...
    return (
      <div>
        ...
        <div style={{pointerEvents: "none", textAlign: "right", width: "100%", height: "0px", margin: "0px", position: "relative", top: "-7px", left: "5px"}}>
          <h3 style={{margin: "0"}}>
            <FontAwesome onClick={execute} style={{pointerEvents: "auto", color:"white", cursor: "pointer"}} className="fa-times-circle" name="closeButton"/>
          </h3>
        </div>
      </div>
    );
